export async function searchMovie(search_data) {
    ...
    try{
        ...
        const response = await fetch('http://http://api.se-rmutl.net:4000/api/movie/search?search_text='+search_data);
...
export async function getAllMovies() {
    ...
    try{
        ...
        const response = await fetch('http://http://api.se-rmutl.net:4000/api/movie/all');
